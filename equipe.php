...
<html lang="fr">
  <head>
    ...
    <meta content="Lork est composé de 3 personnes ayant des compétences différentes mais complémentaires pour répondre au mieux aux besoins de votre projet." name="description">
    ...
    <section id="information-equipe">
      ...
      <div class="row pad2 text-center">
        <div class="col-md-4 col-sm-12 air">
          ...
          <a href="http://lork.fr/emilien-flamein" class="btn-orange-light" target="blank">En voir plus
          </a>
        </div>
        <div class="col-md-4 col-sm-12 air">
          ...
          <a href="http://sachafargeaudou.fr" class="btn-vert-light" target="blank">En voir plus
          </a>
        </div>
        <div class="col-md-4 col-sm-12 air">
          ...
          <a href="http://achillepicarony.ultra-book.com" class="btn-bleu-light" target="blank">En voir plus
          </a>
        </div>
      </div>
      <div class="row pad5">
        <div class="col-md-12 col-sm-12 text-center air">
          <p class="orange text-sept">Pour toute demande de devis ou d'informations complémentaire, n'hésitez pas à nous contacter.
          </p>
        </div>
        <div class="col-md-12 col-sm-12 text-center pad2">
          <a href="contact" class="btn-devis">Faire une demande de devis
          </a>
        </div>
      </div>
    </section>
