...
<![endif]-->
  ...
  <body>
    ...
    <section id="information-equipe">
      ...
      <div class="row">
        <div class="col-md-4 col-md-offset-2 wow bounceInRight animated">
          <p class="orange right">Vous pouvez nous contacter pour toute demande de devis ou tout simplement si vous désirez avoir des informations complémentaires concernant LORK et ses services.
          </p>
        ...
        <div class="col-md-4 wow bounceInLeft animated">
          <p class="bleu">Téléphone : 06.29.61.84.72
          </p>
          <p class="bleu">Mail : lork.freelance@gmail.com
          </p>
          <p class="bleu">Facebook : 
            <a href="https://www.facebook.com/LORK-1705174766410481/" target="blank">Lork
            </a>
          </br>
