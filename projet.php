...
<html lang="fr">
  <head>
    ...
    <meta content="Retrouvez les différents projets réalisés par l'équipe Lork, des clients qui nous ont fait confiance." name="description">
...
<![endif]-->
  ...
  <body>
    ...
    <section id="information-projets">
      <div class="row pad3 ">
        <h1 class="bleu text-center">Nos projets
        </h1>
      </div> 
      <div class="container">
        <ul id="filters" class="clearfix">
          <li>
            <span class="filter active" data-filter=".app, .divers, .logoo, .web">Tous
            </span>
          </li>
          <li>
            <span class="filter" data-filter=".app">Application
            </span>
          </li>
          <li>
            <span class="filter" data-filter=".logoo">Logo
            </span>
          </li>
          <li>
            <span class="filter" data-filter=".web">Web
            </span>
          </li>
          <li>
            <span class="filter" data-filter=".divers">Divers
            </span>
          </li>     
        </ul>
          ...
          <div class="portfolio app" data-cat="app">
            <div class="portfolio-wrapper">           
              <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal"> 
                <img src="images/oby.png" alt="" />
              </a>
              <div class="label">
                <div class="label-text">
                  <a class="text-title">Application / Obygo
                  </a>
                </div>
                <div class="label-bg">
                </div>
          ...
          <div class="portfolio app" data-cat="app">
            <div class="portfolio-wrapper">           
              <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal"> 
                <img src="images/noob2.png" alt="" />
              </a>
              <div class="label">
                <div class="label-text">
                  <a class="text-title">Application / Noob
                  </a>
                </div>
                <div class="label-bg">
                </div>
          ...
          <div class="portfolio web logoo" data-cat="web logoo">
            <div class="portfolio-wrapper">           
              <a href="#portfolioModal3" class="portfolio-link" data-toggle="modal"> 
                <img src="images/jerome.png" alt="" />
              </a>
              <div class="label">
                <div class="label-text">
                  <a class="text-title">Site / Studio3delta
                  </a>
                </div>
                <div class="label-bg">
                </div>
          ...
          <div class="portfolio divers" data-cat="divers">
            <div class="portfolio-wrapper">           
              <a href="#portfolioModal6" class="portfolio-link" data-toggle="modal"> 
                <img src="images/tatoo1.jpg" alt="" />
              </a>
              <div class="label">
                <div class="label-text">
                  <a class="text-title">Poster / Salon de tatouage
                  </a>
                </div>
                <div class="label-bg">
                </div>
          ...
          <div class="portfolio divers" data-cat="divers">
            <div class="portfolio-wrapper">           
              <a href="#portfolioModal7" class="portfolio-link" data-toggle="modal"> 
                <img src="images/Obygo-tript.jpg" alt="" />
              </a>
              <div class="label">
                <div class="label-text">
                  <a class="text-title">Triptyque / Obygo
                  </a>
                </div>
                <div class="label-bg">
                </div>
