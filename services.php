...
<body>
        ...
        <section id="information-services">
                ...
                <!--**************BRANDING************-->
                <div class="row pad2">
                        <div class="col-md-6 right wow bounceInRight animated"><img height="270" src="images/branding.jpg" width="430" alt="service-branding" class="img-respon"></div>
                ...
                <div class="row pad2">
                        ...
                        <div class="col-md-6 wow bounceInLeft animated"><img height="270" src="images/graphisme.jpg" width="430" alt="service-graphisme" class="img-respon"></div>
                </div>
                <!--**************DEV************-->
                <div class="row pad2">
                        <div class="col-md-6 right"><img height="270" src=
                        "images/programmation-web.jpg" width="430" alt="service-developpement" class="img-respon"></div>
                        <div class="col-md-4">
                ...
                <div class="row pad2">
                        ...
                        <div class="col-md-6"><img height="270" src="images/seo.jpg" width="430" alt="service-referencement" class="img-respon"></div>
                </div>
                <div class="row pad2">
